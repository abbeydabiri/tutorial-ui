        ...
        <div class="center mw7 mw6-l" >
          <article class="dt min-vh-100 w-100 ph0-l pa3 center" style="max-width:350px">
              ...
              <div class="dtc v-mid tc center " style="" >
                ...
                <img src="@/assets/logo.svg" class="h4 tc " />

                <div class="w-100 fl">
                  <p class="cf db w-100 f5 pt2 pb2 mid-gray tracked fw4">Sign in to your Tutorial Account</p>
                </div>
